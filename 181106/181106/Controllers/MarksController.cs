...
namespace _181106.Controllers
{
    public class MarksController : Controller
    {
        private readonly _181106Context _context;

        public MarksController(_181106Context context)
        {
            _context = context;
        }
        ...
        {
            var _181106Context = _context.Mark.Include(m => m.Student);
            return View(await _181106Context.ToListAsync());
        }
